WITH glue_swaps AS (
    ...
    WHERE hooks IN (0xb216070c3509047ea597e2e626a29cea427a60c8, 0x0f41715dc432692b66a5adf8dcfef6ac407b20c8, 0xbb021554c5294328b04fa313669715bd201ba040) AND block_number >= 25703029 AND block_date >= DATE '2026-06-01'
    UNION ALL
    SELECT 'base' AS blockchain, tx_hash, evt_index FROM uniswap_v4_base.base_trades
    WHERE hooks IN (0xb216070c3509047ea597e2e626a29cea427a60c8, 0x0f41715dc432692b66a5adf8dcfef6ac407b20c8, 0xbb021554c5294328b04fa313669715bd201ba040) AND block_number >= 49657824 AND block_date >= DATE '2026-06-01'
    UNION ALL
    SELECT 'arbitrum' AS blockchain, tx_hash, evt_index FROM uniswap_v4_arbitrum.base_trades
    WHERE hooks IN (0xb216070c3509047ea597e2e626a29cea427a60c8, 0x0f41715dc432692b66a5adf8dcfef6ac407b20c8, 0xbb021554c5294328b04fa313669715bd201ba040) AND block_number >= 492046075 AND block_date >= DATE '2026-06-01'
    UNION ALL
    SELECT 'optimism' AS blockchain, tx_hash, evt_index FROM uniswap_v4_optimism.base_trades
    WHERE hooks IN (0xb216070c3509047ea597e2e626a29cea427a60c8, 0x0f41715dc432692b66a5adf8dcfef6ac407b20c8, 0xbb021554c5294328b04fa313669715bd201ba040) AND block_number >= 155253116 AND block_date >= DATE '2026-06-01'
    UNION ALL
    SELECT 'bnb' AS blockchain, tx_hash, evt_index FROM uniswap_v4_bnb.base_trades
    WHERE hooks IN (0xb216070c3509047ea597e2e626a29cea427a60c8, 0x0f41715dc432692b66a5adf8dcfef6ac407b20c8, 0xbb021554c5294328b04fa313669715bd201ba040) AND block_number >= 114546905 AND block_date >= DATE '2026-06-01'
    UNION ALL
    SELECT 'polygon' AS blockchain, tx_hash, evt_index FROM uniswap_v4_polygon.base_trades
    WHERE hooks IN (0xb216070c3509047ea597e2e626a29cea427a60c8, 0x0f41715dc432692b66a5adf8dcfef6ac407b20c8, 0xbb021554c5294328b04fa313669715bd201ba040) AND block_number >= 91600016 AND block_date >= DATE '2026-06-01'
    UNION ALL
    SELECT 'avalanche_c' AS blockchain, tx_hash, evt_index FROM uniswap_v4_avalanche_c.base_trades
    WHERE hooks IN (0xb216070c3509047ea597e2e626a29cea427a60c8, 0x0f41715dc432692b66a5adf8dcfef6ac407b20c8, 0xbb021554c5294328b04fa313669715bd201ba040) AND block_number >= 92242906 AND block_date >= DATE '2026-06-01'
    UNION ALL
    SELECT 'blast' AS blockchain, tx_hash, evt_index FROM uniswap_v4_blast.base_trades
    WHERE hooks IN (0xb216070c3509047ea597e2e626a29cea427a60c8, 0x0f41715dc432692b66a5adf8dcfef6ac407b20c8, 0xbb021554c5294328b04fa313669715bd201ba040) AND block_date >= DATE '2026-06-01'
    UNION ALL
    ...
    WHERE hooks IN (0xb216070c3509047ea597e2e626a29cea427a60c8, 0x0f41715dc432692b66a5adf8dcfef6ac407b20c8, 0xbb021554c5294328b04fa313669715bd201ba040) AND block_number >= 33384712 AND block_date >= DATE '2026-06-01'
    UNION ALL
    SELECT 'unichain' AS blockchain, tx_hash, evt_index FROM uniswap_v4_unichain.base_trades
    WHERE hooks IN (0xb216070c3509047ea597e2e626a29cea427a60c8, 0x0f41715dc432692b66a5adf8dcfef6ac407b20c8, 0xbb021554c5294328b04fa313669715bd201ba040) AND block_number >= 55356883 AND block_date >= DATE '2026-06-01'
    UNION ALL
    ...
    WHERE hooks IN (0xb216070c3509047ea597e2e626a29cea427a60c8, 0x0f41715dc432692b66a5adf8dcfef6ac407b20c8, 0xbb021554c5294328b04fa313669715bd201ba040) AND block_number >= 30206983 AND block_date >= DATE '2026-06-01'
    UNION ALL
