...
const DESCRIPTION =
  "A free, open-source Uniswap V4 hook that automates buybacks, burns and self-compounding liquidity — on-chain, contract-to-contract, no oracles, no keepers, no team actions. Same address on 14 mainnets.";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "buyback hook", "V4 liquidity", "DeFi buyback", "token burn",
    "GlueHook", "Glue",
  ],
  ...
  openGraph: {
    ...
    title: TITLE,
    description:
      "Automated buybacks, burns and self-growing liquidity for any Uniswap V4 pool. No oracles, no keepers, no fee — same address on 14 mainnets.",
    locale: "en_US",
    images: [
  ...
  twitter: {
    ...
    title: TITLE,
    description:
      "Automated buybacks, burns and self-growing liquidity for any Uniswap V4 pool — same address on 14 mainnets.",
    images: ["/og.png"],
  },
  robots: {
    index: true,
...
const JSON_LD = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      operatingSystem: "EVM (14 mainnets)",
      description:
        "A Uniswap V4 hook that automates buybacks, burns, auto-harvesting and self-compounding liquidity for any pool. Deployed at the same canonical address (0x03D482cB3Ff339C2d29736818D0F72c66dD6A040) on 14 mainnets, source-verified and open-source.",
